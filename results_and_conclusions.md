...
Lets analyze the range of eigenvalues of the Laplacian matrix![](https://github.com/Ayo1a/Final-research-project/blob/main/images/Laplacian.PNG), denoted by 𝜆 (the spectral gap). ![see here the results of the various matrices in the Laplacian calculation created by running the code]()
